...
EuclideanClusteringFlexibleTolerance::EuclideanClusteringFlexibleTolerance()
    : nhPrivate("~")
{
  sub_pc = nh.subscribe("/points2", 1, &EuclideanClusteringFlexibleTolerance::CallbackPC, this);
...
void EuclideanClusteringFlexibleTolerance::Sampling(void)
{
...
void EuclideanClusteringFlexibleTolerance::Publish()
{
